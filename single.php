   			...
   			<article class="format-standard">  
   				...
   				<div class="content-media">
						<div class="post-thumb">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/thumbs/single/single-01.jpg"> 
						</div>  
					</div>
					...
					<div class="primary-content">
						...
						<p><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/shutterbug.jpg" alt=""></p>
						...
						<p class="tags">
		  			   ...
		  			   <div class="author-profile">
		  			   	<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/avatars/user-05.jpg" alt="">
	  			   ...
	  			   <div class="pagenav group">
						...
						<?php
							...
							'prev_text' => '<div class="prev-nav"><span>' . __( 'Previous post:', 'twentyfifteen' ) . '</span>%title</div>',
							'next_text' => '<div class="next-nav"><span>' . __( 'Next post:', 'twentyfifteen' ) . '</span>%title</div>',
							) );
						?>
		  			   <!--<div class="prev-nav">
		  			   	<a href="#" rel="prev">
